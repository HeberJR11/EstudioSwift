...
/// El `tableView` es un control que permite mostrar *secciones* que contienen *filas* y cada fila es representada
/// por una *celda*. Podemos pensar en grupos de *celdas* llamados secciones.
///
/// Existen dos formas de controlar un *tableView*:
///
/// * **A través de un UITableViewController** - Este *viewController* posee todas las implementaciones por defecto de
/// *UITableViewDelegate*, tambien enlazar el `@IBoutlet` hacía el *UITableView* y ajustar `dataSource` y `.delgate`
///
/// Vamos a construir un *tableView*
